...
def test_content_marker_is_actually_present_on_the_committed_page() -> None:
    ...
    no CI warning, since nothing today ties the two together. dashboard/public/
    is a build artifact regenerated by scripts/build_dashboard.py, but it is
    also committed, so this can check it directly like any other test here."""
